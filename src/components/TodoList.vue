    ...
    <div class="task-container">
        ...
        <div v-for="(todo, index) in todos" :key="todo.id" id="edit" class="todo-item" @dblclick="edititem(index)">
            <div class="todo-item-label" :class="{ completed: todo.completed }" :id="'todo_' + todo.id">
                <div>
                    ...
                    <div v-if="todo.isEdit" class="save_cancle-btn">
                        <button @click="onSave(index)" class="save-btn">Save</button>
                        <button @click="onCancel(index)" class="cancle-btn">Cancel</button>
                    </div>
                </div>
        ...
        <div class="progressBar">
            <div class="completionProgressBar">
                ...
                <div class="completionProgressGreyBar text-center" :style="{ width: percentageOfTasksCompleted + '%' }">
                </div>
            </div>
        </div>
    </div>
